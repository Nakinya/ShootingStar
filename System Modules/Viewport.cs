...
public class Viewport : Singleton<Viewport>
{
    ...
    private void Start()
    {
        ...
        Vector3 bottomLeft = mainCamera.ViewportToWorldPoint(new Vector3(0f,0f));//视口坐标转换到世界坐标
    ...
    public Vector3 PlayerMoveablePosition(Vector3 playerPosition,float paddingX,float paddingY)//限制玩家移动范围
    {
